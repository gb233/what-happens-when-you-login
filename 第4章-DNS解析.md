...
DoH带来的新问题：
  ✗ DNS查询集中到少数DoH提供商（Cloudflare/Google），产生新的中心化风险
  ✗ 企业安全团队失去DNS可见性，无法通过DNS日志检测内网威胁
  ✗ DoH提供商可以看到你的所有DNS查询（信任从ISP转移到DoH提供商）
